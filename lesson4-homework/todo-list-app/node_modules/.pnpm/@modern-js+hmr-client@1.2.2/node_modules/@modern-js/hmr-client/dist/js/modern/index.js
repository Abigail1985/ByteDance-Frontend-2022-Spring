...
ErrorOverlay.setEditorHandler(function editorHandler(errorLocation) {
  fetch(`${LAUNCH_EDITOR_ENDPOINT}?filename=${window.encodeURIComponent(errorLocation.fileName)}&line=${window.encodeURIComponent(errorLocation.lineNumber || 1)}&column=${window.encodeURIComponent(errorLocation.colNumber || 1)}`);
