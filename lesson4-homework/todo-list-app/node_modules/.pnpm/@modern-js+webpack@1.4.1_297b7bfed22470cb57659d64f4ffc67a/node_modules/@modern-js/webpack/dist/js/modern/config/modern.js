...
import { applyOptionsChain, isUseSSRBundle, removeLeadingSlash } from '@modern-js/utils';
...
class ModernWebpackConfig extends ClientWebpackConfig {
  constructor(appContext, options) {
    ...
    this.htmlFilename = name => removeLeadingSlash(`${this.options.output.htmlPath}/${this.options.output.disableHtmlFolder ? `${name}-es6` : `${name}/index-es6`}.html`);
