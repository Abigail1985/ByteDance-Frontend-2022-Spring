...
import { isBeyondReact17 } from "./utils"; // import { isPnpm } from './utils';
...
export const genCommon = options => {
  const {
  ...
  const baseConfigChain = getBaseBabelChain({
    ...
    plugins: {
      ...
      transformReactRemovePropTypes: isProd() ? {// 内部默认 removeImport: true,
      } : false,
