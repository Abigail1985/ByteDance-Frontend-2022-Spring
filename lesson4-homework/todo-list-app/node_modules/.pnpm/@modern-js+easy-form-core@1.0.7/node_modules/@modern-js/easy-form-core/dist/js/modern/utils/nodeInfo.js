...
export const fieldValue = (key, schema, data, extra) => {
...
export const getSchemaLabel = (schema, data, extra) => fieldValue('label', schema, data, extra) || '';
export const getSchemaDisabled = (schema, data, extra) => {
  var _schema$state;
...
export const getSchemaDefaultState = schema => {
...
export const getNodeInfo = (schema, data, extra) => _objectSpread(_objectSpread({
