...
export const extractModuleInfoFromFilenames = (apiDir, filenames) => {
  const moduleInfos = [];
...
export const extractAPIHandlersFromModuleInfos = moduleInfos => {
  const apiHandlers = [];
  moduleInfos.forEach(({
    name,
    module
...
export const getRouteName = (pwd, filename) => {
